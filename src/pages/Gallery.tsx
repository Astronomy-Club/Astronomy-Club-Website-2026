...
const images: string[] = [];
for (let i = 1; i <= 105; i++) {
  // repeated photos thus continuing otherwise have to renumber again
  if(i == 25 || i==50 || i==76 || i==85 || i==86 || i==87 || i==88 || i==93){
    continue;
  }
...
function Gallery() {
  ...
  const nextImage = (e: React.MouseEvent) => {
    ...
    setSelectedImageIndex(
      (prev) => (prev !== null ? prev + 1 : 0) % images.length,
    );
  };
      ...
      <div className="relative container px-5 py-10 mx-auto">
        <div className="flex flex-col text-center text-white w-full mb-10">
          ...
          <p className="lg:w-2/3 mx-auto leading-relaxed">
            ...
            different colleges, Alumni meets, parties, orientations, workshops,
